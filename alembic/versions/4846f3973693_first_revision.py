...
Revision ID: 4846f3973693
Revises: 
Create Date: 2024-06-22 12:50:59.786660
...
def upgrade() -> None:
    ...
    sa.Column('created_on', sa.DateTime(), nullable=False),
    sa.Column('default_maintenance_threshold', sa.DOUBLE_PRECISION(), nullable=False),
    sa.Column('default_warning_threshold', sa.DOUBLE_PRECISION(), nullable=False),
    sa.Column('default_danger_threshold', sa.DOUBLE_PRECISION(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['institution_number'], ['institution_tab.id'], ),
    sa.PrimaryKeyConstraint('registration_id')
    )
