...
Revision ID: 4b596ce25722
Revises: b18dc536afe6
Create Date: 2024-07-03 19:08:43.798254
...
revision: str = '4b596ce25722'
down_revision: Union[str, None] = 'b18dc536afe6'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['clinician_id'], ['clinician_tab.registration_id'], ),
    sa.ForeignKeyConstraint(['institution_id'], ['institution_tab.id'], ),
    sa.PrimaryKeyConstraint('registration_id'),
    ...
    sa.Column('prescription_status', sa.Enum('ACTIVE', 'ON_HOLD', 'CANCCELED', name='prescription_status'), server_default='ACTIVE', nullable=False),
    sa.Column('medication_refrence', sa.String(), nullable=True),
    sa.Column('medication_json', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.ForeignKeyConstraint(['clinician_refrence'], ['clinician_tab.registration_id'], ),
    sa.ForeignKeyConstraint(['medication_refrence'], ['medication_tab.medication_reference'], ),
    sa.ForeignKeyConstraint(['patient_refrence'], ['patient_tab.registration_id'], ),
