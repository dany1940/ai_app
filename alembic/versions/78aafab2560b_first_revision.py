...
def upgrade() -> None:
    ...
    op.create_table(
        "clinical_trial_tab",
        sa.Column(
            "clinical_trial_id", sa.Integer(), sa.Identity(always=True), nullable=False
        ),
    ...
    op.create_table(
        "prescription_tab",
        sa.Column(
            "prescription_id", sa.Integer(), sa.Identity(always=True), nullable=False
        ),
        ...
        sa.Column(
            "prescription_status",
            sa.Enum("ACTIVE", "ON_HOLD", "CANCELLED", name="prescription_status"),
            server_default="ACTIVE",
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        "apointment_tab",
        sa.Column(
            "apointment_id", sa.Integer(), sa.Identity(always=True), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["clincal_trial_id"],
            ["clinical_trial_tab.clinical_trial_id"],
        ),
        sa.ForeignKeyConstraint(
            ["clinician_refrence"],
            ["clinician_tab.registration_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["prescription_refrence"],
            ["prescription_tab.prescription_id"],
        ),
