...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "medication_request_id", sa.VARCHAR(), autoincrement=False, nullable=False
        ),
        sa.Column("medication_code", sa.VARCHAR(), autoincrement=False, nullable=False),
        sa.Column(
            "clinician_refrence", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "ACTIVE", "ON_HOLD", "CANCELLED", "COMPLETED", name="status"
            ),
        ...
        sa.ForeignKeyConstraint(
            ...
            name="medication_request_tab_clinician_refrence_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["patient_refrence"],
            ["patient_tab.registration_id"],
            name="medication_request_tab_patient_refrence_fkey",
        ),
        sa.PrimaryKeyConstraint(
            "medication_request_id", name="medication_request_tab_pkey"
        ),
    )
    # ### end Alembic commands ###
