...
user_to_create = [
    ...
    "password":"password",
    "is_admin":True,
    "organization_name":"FDADFASHJJKD"
    }
]
...
class TestUser:
    ...
    @pytest.mark.parametrize("user",  user_to_create)
    def test_post_create_organization(self, user: dict[Any, Any], client: TestClient) -> None:
            """
            Test the creqtion of an user
            data.
            """
